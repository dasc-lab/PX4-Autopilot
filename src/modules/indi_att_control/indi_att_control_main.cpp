...
IndiAttitudeControl::IndiAttitudeControl(bool vtol) :
...
IndiAttitudeControl::~IndiAttitudeControl()
{
	perf_free(_loop_perf);
}

bool
IndiAttitudeControl::init()
{
...
void
IndiAttitudeControl::parameters_updated()
{
...
float
IndiAttitudeControl::throttle_curve(float throttle_stick_input)
{
...
void
IndiAttitudeControl::generate_attitude_setpoint(const Quatf &q, float dt, bool reset_yaw_sp)
{
...
int IndiAttitudeControl::task_spawn(int argc, char *argv[])
{
	bool vtol = false;
	...
	IndiAttitudeControl *instance = new IndiAttitudeControl(vtol);
...
int IndiAttitudeControl::custom_command(int argc, char *argv[])
{
	return print_usage("unknown command");
}

int IndiAttitudeControl::print_usage(const char *reason)
{
	if (reason) {
		PX4_WARN("%s\n", reason);
	}
...
{
	return IndiAttitudeControl::main(argc, argv);
}
