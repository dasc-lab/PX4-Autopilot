...
void IndiControl::update_allocator_rpm_bounds(const float min_rpm, const float max_rpm){
...
void IndiControl::update_allocator_matrices(const Matrix4f H, const Matrix4f G){
