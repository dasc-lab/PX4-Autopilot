...
class IndiPositionControl : public ModuleBase<IndiPositionControl>, public control::SuperBlock,
	public ModuleParams, public px4::ScheduledWorkItem
{
public:
	IndiPositionControl(bool vtol = false);
	~IndiPositionControl() override;
